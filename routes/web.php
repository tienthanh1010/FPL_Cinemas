...
Route::get('/booking/{booking_code}/payment/{payment}/status', [CheckoutController::class, 'paymentStatus'])->name('booking.payment.status');
Route::post('/booking/{booking_code}/payment/{payment}/momo-local-success', [CheckoutController::class, 'momoLocalSuccess'])->name('booking.payment.momo.local-success');
