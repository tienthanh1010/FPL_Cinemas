...
@section('content')
  ...
  <section class="hero-section section-space pt-4 pt-lg-5">
    <div class="container-fluid app-container">
      <div class="hero-shell hero-shell--compact hero-shell--fullwidth">
    ...
    <div class="container-fluid app-container">
      ...
      @if($sectionFilter === 'all' || $sectionFilter === 'hot')
        <div class="movie-section-block">
          <div class="section-heading mb-3">
            <div>
              <span class="section-eyebrow">Phim Hot</span>
            </div>
          </div>
          <div class="row g-4">
      ...
      @if($sectionFilter === 'all' || $sectionFilter === 'now')
        <div class="movie-section-block">
          <div class="section-heading mb-3">
            <div>
              <span class="section-eyebrow">Phim đang chiếu</span>
            </div>
          </div>
          <div class="row g-4">
      ...
      @if($sectionFilter === 'all' || $sectionFilter === 'coming')
        <div class="movie-section-block">
          <div class="section-heading mb-3">
            <div>
              <span class="section-eyebrow">Phim sắp chiếu</span>
            </div>
          </div>
          <div class="row g-4">
