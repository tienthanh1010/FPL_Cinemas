...
@section('title', 'Hồ sơ giá động')

@section('content')
<section class="page-header">
    <div>
        <p class="eyebrow">Pricing profiles</p>
        <h2>Hồ sơ giá động</h2>
        <p>Quản lý quy tắc giá theo ngày, giờ, loại ghế, đối tượng vé, cuối tuần và ngày đặc biệt.</p>
    </div>
    <a href="{{ route('admin.pricing_profiles.create') }}" class="btn btn-primary">Tạo hồ sơ giá</a>
</section>

<div class="card">
    <div class="card-body border-bottom">
        <form class="row g-2">
            <div class="col-md-6"><input type="text" name="q" value="{{ $q }}" class="form-control" placeholder="Tìm theo tên hoặc mã hồ sơ giá"></div>
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            @empty
                <tr><td colspan="6" class="empty-state">Chưa có hồ sơ giá nào.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
