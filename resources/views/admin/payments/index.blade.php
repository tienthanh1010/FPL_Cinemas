...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-3"><div class="metric-card"><div class="metric-label">Thanh toán chờ xử lý</div><div class="metric-value">{{ number_format($summary['initiated_count']) }}</div></div></div>
            ...
            @forelse($payments as $payment)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="list-secondary">Booking đã thu {{ number_format((int) ($payment->booking?->paid_amount ?? 0)) }}đ</div>
                    </td>
